                	...
                	<form action="/dashboard" method="post">
						...
						<div class="col-md-6">
                			...
                			<div class="row">
						  	...
						  	<h4><b><u>Timeline Project</u></b></h4>
						  	<div class="row">
						  		<ul class="list-group">
						      			<li class="list-group-item"> AT HARBOR<span class="badge">{{$edit->at_harbor}}</span></li>
							  	</ul>
		                		<ul class="list-group">
						      			<li class="list-group-item"> AT SEA<span class="badge">{{$edit->at_sea}}</span></li>
							  	</ul>
					            <ul class="list-group">
						      			<li class="list-group-item"> AT LANDED<span class="badge">{{$edit->at_landed}}</span></li>
							  	</ul>
					            <ul class="list-group">
						      			<li class="list-group-item"> AT RECEIVED <span class="badge">{{$edit->at_received}}</span></li>
							  	</ul>
					                <a href="/dashboard" class="form-control btn btn-primary"> Back </a>
					            </div>
						  	</div>
                		</div>
